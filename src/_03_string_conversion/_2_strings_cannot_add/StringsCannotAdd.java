...
public class StringsCannotAdd {
		...
		public static void main(String[] args) {
			...
			int sixnum = Integer.parseInt(sixAsString);
			// 8) Print the addition of fourAsInt and sixAsInt using JOptionPane 
			JOptionPane.showMessageDialog(null, num + sixnum);
			...
			int fivenum = Integer.parseInt(fiveAsString);
			// 10) Print the addition of fourAsInt, sixAsInt, and fiveAsInt using JOptionPane 
			JOptionPane.showMessageDialog(null, num + sixnum + fivenum);
